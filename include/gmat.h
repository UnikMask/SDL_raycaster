...
template <class T> gmat<T> gmat_add(struct gmat<T> a, struct gmat<T> b);
/* Matrix to matrix substraction */
template <class T> gmat<T> gmat_sub(struct gmat<T> a, struct gmat<T> b);
/* Matrix to constant addition */
template <class T> gmat<T> gmat_add(struct gmat<T> a, T b);
/* Matrix to constant substraction */
template <class T> gmat<T> gmat_sub(struct gmat<T> a, T b);
/* Matrix to matrix multiplication */
template <class T> gmat<T> gmat_mult(struct gmat<T> a, struct gmat<T> b);
/* Vector to matrix multiplication */
template <class T> gvec<T> gmat_mult(struct gvec<T> a, struct gmat<T> b);
/* Matrix to vector multiplication */
template <class T> gvec<T> gmat_mult(struct gmat<T> a, struct gvec<T> b);
/* Matrix to matrix by-element multiplication */
template <class T> gmat<T> gmat_bemult(struct gmat<T> a, struct gmat<T> b);
/* Matrix equality */
